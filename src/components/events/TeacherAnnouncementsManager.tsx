...
interface TeacherAnnouncementsManagerProps {
  userId: string;
}

export function TeacherAnnouncementsManager({ userId }: TeacherAnnouncementsManagerProps) {
                ...
                <div className="flex items-center justify-between">
                  ...
                  {announcement.created_by === userId && (
                    <Button 
                      variant="ghost" 
                      size="icon" 
                      onClick={() => handleDelete(announcement.id, announcement.created_by)}
                    >
